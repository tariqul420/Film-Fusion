...
const AddUpcoming = () => {
    ...
    return (
        <section className="w-full h-auto flex items-center justify-center sm:py-12 p-6">
            <div className="w-full sm:w-[40%] lg:w-[50%] dark:bg-gray-700 bg-gray-400 rounded-lg sm:py-6 sm:px-8 p-4 flex flex-col gap-5 shadow-md">
                <form onSubmit={handleSubmit(onSubmit)} className="w-full flex flex-col gap-5">
                    ...
                    <input
                        ...
                        className="py-3 px-4 border focus:outline-color-primary border-gray-300 dark:bg-color-primary-d bg-gray-200 rounded-lg w-full  dark:placeholder-color-white placeholder-color-gray-600"
                        {...register("releaseDate", { required: true })}
                    />

                    <textarea
                        placeholder="Please enter movie details"
                        className="py-3 min-h-[150px] dark:bg-color-primary-d bg-gray-200 font-medium px-4 border focus:outline-[#3B82F6] border-gray-300 rounded-lg w-full"
