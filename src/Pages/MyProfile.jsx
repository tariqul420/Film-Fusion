...
const MyProfile = () => {
    ...
    return (
        <div className="w-11/12 lg:w-9/12 mx-auto my-12">
            ...
            <div className="border-2 border-solid dark:border-gray-500 border-gray-200 hover:shadow-lg p-12 rounded-lg flex flex-col lg:flex-row items-center justify-center gap-8 mt-8 dark:bg-gray-700 bg-white shadow-md">
                ...
                <div className="flex items-center justify-center flex-col lg:items-start">
                    ...
                    <button
                        ...
                        <span className="absolute inset-0 flex items-center justify-center w-full h-full dark:text-white text-color-primary-d duration-300 -translate-x-full dark:bg-color-primary-d bg-[#e9f8fe] group-hover:translate-x-0 ease">
