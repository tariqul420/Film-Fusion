...
const MyProfile = () => {
    ...
    return (
        <div className="w-11/12 lg:w-9/12 mx-auto my-12">
            ...
            <div className="border-2 border-solid border-gray-500 shadow-md hover:shadow-lg p-12 rounded-lg flex flex-col lg:flex-row items-center justify-center gap-8 mt-8 bg-gray-700">
